...
originPir.z+=2.0f;
     ...
     for(int i=0;i<6;i++)
  {
    pir.trig[i].p1=Math::rotationVec3f(pir.trig[i].p1-originPir, {0.0f,0.0f,1.0f}, 180)+originPir;
    pir.trig[i].p2=Math::rotationVec3f(pir.trig[i].p2-originPir, {0.0f,0.0f,1.0f}, 180)+originPir;
    pir.trig[i].p3=Math::rotationVec3f(pir.trig[i].p3-originPir, {0.0f,0.0f,1.0f}, 180)+originPir;
  }
...
Window window("My Window",800,600);
  ...
  for(int i=0;i<12;i++)
  {
    shape.trig[i].p1=Math::rotationVec3f(shape.trig[i].p1-origin, {0.0f,0.0f,1.0f}, 0.1)+origin;
    shape.trig[i].p2=Math::rotationVec3f(shape.trig[i].p2-origin, {0.0f,0.0f,1.0f}, 0.1)+origin;
    shape.trig[i].p3=Math::rotationVec3f(shape.trig[i].p3-origin, {0.0f,0.0f,1.0f}, 0.1)+origin;
  }

    for(int i=0;i<12;i++)
  {
    shape.trig[i].p1=Math::rotationVec3f(shape.trig[i].p1-origin, {0.0f,1.0f,0.0f}, 0.1)+origin;
    shape.trig[i].p2=Math::rotationVec3f(shape.trig[i].p2-origin, {0.0f,1.0f,0.0f}, 0.1)+origin;
    shape.trig[i].p3=Math::rotationVec3f(shape.trig[i].p3-origin, {0.0f,1.0f,0.0f}, 0.1)+origin;
  }
    ...
    if(shape.trig[i].p3.z>d1)
    {
       ...
       Math::Matrix m1=Math::ogProjection3f(shape.trig[i].p1, angle, d1, d2, a);
       Math::Matrix m2=Math::ogProjection3f(shape.trig[i].p2, angle, d1, d2, a);
       Math::Matrix m3=Math::ogProjection3f(shape.trig[i].p3, angle, d1, d2, a);
  ...
  Math::vec3f normal=Math::VectorCrossProduct3D(line1, line2);
    ...
    {  Math::vec2f p1,p2,p3;
       ...
       Math::Matrix m1=Math::ogProjection3f(pir.trig[i].p1, angle, d1, d2, a);
       Math::Matrix m2=Math::ogProjection3f(pir.trig[i].p2, angle, d1, d2, a);
       Math::Matrix m3=Math::ogProjection3f(pir.trig[i].p3, angle, d1, d2, a);
